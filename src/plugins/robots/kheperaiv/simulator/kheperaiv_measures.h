...
extern const Real KHEPERAIV_GRIPPER_RING_RADIUS;
extern const Real KHEPERAIV_GRIPPER_RADIUS;
extern const Real KHEPERAIV_GRIPPER_ELEVATION;
...
extern const Real TURRET_PD_P_CONSTANT;
extern const Real TURRET_PD_D_CONSTANT;
