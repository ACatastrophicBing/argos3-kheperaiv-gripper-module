...
// const Real KHEPERAIV_BASE_TOP       = 0.0577;
...
// const Real KHEPERAIV_GRIPPER_RING_RADIUS = 0.0804;
const Real KHEPERAIV_GRIPPER_RING_RADIUS = 0.08814;
const Real KHEPERAIV_GRIPPER_RADIUS = 0.09855;
const Real KHEPERAIV_GRIPPER_ELEVATION = KHEPERAIV_BASE_TOP + 0.0000; //plus some amount
...
const Real TURRET_PD_P_CONSTANT = 0.4;
const Real TURRET_PD_D_CONSTANT = 0.2;
