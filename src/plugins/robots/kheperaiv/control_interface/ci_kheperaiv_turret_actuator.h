/**
 * @file <argos3/plugins/robots/kheperaiv/control_interface/ci_kheperaiv_turret_actuator.h>
 *
...
#define CCI_KHEPERAIV_TURRET_ACTUATOR_H

namespace argos {
   class CCI_KheperaIVTurretActuator;
}
...
namespace argos {
   ...
   public:
       ...
       * Destructor.
       */
      virtual ~CCI_KheperaIVTurretActuator() {}
